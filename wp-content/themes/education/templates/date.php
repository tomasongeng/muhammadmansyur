...
if ( !function_exists( 'themerex_template_date_theme_setup' ) ) {
	...
	function themerex_template_date_theme_setup() {
		themerex_add_template(array(
			'layout' => 'date',
			'mode'   => 'blogger',
			'title'  => __('Blogger layout: Timeline', 'education')
			));
	}
}
	...
	function themerex_template_date_output($post_options, $post_data) {
		...
		<div class="post_item sc_blogger_item
			...
			<div class="post_content">
				...
				<div class="post_info">
					<span class="post_info_item post_info_posted_by"><?php _e('by', 'education'); ?> <a href="<?php echo esc_url($post_data['post_author_url']); ?>" class="post_info_author"><?php echo esc_html($post_data['post_author']); ?></a></span>
