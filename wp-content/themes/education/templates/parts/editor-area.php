...
if ($post_data['post_edit_enable']) {
	...
	wp_enqueue_style ( 'frontend-editor-style', themerex_get_file_url('js/core.editor/core.editor.css'), array(), null );
	wp_enqueue_script( 'frontend-editor',       themerex_get_file_url('js/core.editor/core.editor.js'),  array(), null, true );
	...
	<div id="frontend_editor">
		<div id="frontend_editor_inner">
			<form method="post">
				<label id="frontend_editor_post_title_label" for="frontend_editor_post_title"><?php _e('Title', 'education'); ?></label>
				...
				?>
				<label id="frontend_editor_post_excerpt_label" for="frontend_editor_post_excerpt"><?php _e('Excerpt', 'education'); ?></label>
				...
				<input type="button" id="frontend_editor_button_save" value="<?php echo esc_attr(__('Save', 'education')); ?>" />
				<input type="button" id="frontend_editor_button_cancel" value="<?php echo esc_attr(__('Cancel', 'education')); ?>" />
