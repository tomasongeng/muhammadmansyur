...
if (!function_exists('themerex_attachment_theme_setup')) {
	...
	function themerex_attachment_theme_setup() {
		...
		themerex_require_data( 'taxonomy', 'media_folder', array(
			...
			'hierarchical' 		=> true,
			'labels' 			=> array(
				'name'              => __('Media Folders', 'education'),
				'singular_name'     => __('Media Folder', 'education'),
				'search_items'      => __('Search Media Folders', 'education'),
				'all_items'         => __('All Media Folders', 'education'),
				'parent_item'       => __('Parent Media Folder', 'education'),
				'parent_item_colon' => __('Parent Media Folder:', 'education'),
				'edit_item'         => __('Edit Media Folder', 'education'),
				'update_item'       => __('Update Media Folder', 'education'),
				'add_new_item'      => __('Add New Media Folder', 'education'),
				'new_item_name'     => __('New Media Folder Name', 'education'),
				'menu_name'         => __('Media Folders', 'education'),
			),
			'query_var'			=> true,
...
if (!function_exists('themerex_attachment_view_filters')) {
	...
	function themerex_attachment_view_filters($settings, $post=null) {
		...
		foreach ($taxes as $tax) {
			...
			if (count($terms) > 0) {
				$settings['mimeTypes'][$tax.'.'] = __('Media without folders', 'education');
