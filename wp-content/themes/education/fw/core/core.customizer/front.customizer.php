...
<div id="custom_options" class="custom_options <?php echo esc_attr($co_style); ?>">
	...
	<div class="co_header">
		<div class="co_title">
			<span><?php _e('Style switcher', 'education'); ?></span>
			<a href="#" id="co_theme_reset" class="co_reset icon-retweet-1" title="<?php _e('Reset to defaults', 'education'); ?>"><?php _e('RESET', 'education'); ?></a>
		</div>
	</div>
		...
		<div class="sc_scroll_wrapper swiper-wrapper">
			<div class="sc_scroll_slide swiper-slide">
				...
				<div class="co_section">
					<div class="co_label"><?php _e('Body styles', 'education'); ?></div>
					<div class="co_switch_box co_switch_horizontal co_switch_columns_3<?php /* co_switch_vertical|horizontal,co_switch_columns_3|4 */ ?>" data-options="body_style">
						...
						<a href="#" data-value="boxed"><?php _e('Boxed', 'education'); ?></a>
						<a href="#" data-value="wide"><?php _e('Wide', 'education'); ?></a>
						<a href="#" data-value="fullscreen"><?php _e('Fullscreen', 'education'); ?></a>
					</div>
				</div>

				<div class="co_section">
					<div class="co_label"><?php _e('Color scheme', 'education'); ?></div>
				...
				<div class="co_section">
					<div class="co_label"><?php _e('Color settings', 'education'); ?></div>
					<div class="co_colorpic_list">
						<div class="iColorPicker" data-options="link_color" data-value="<?php echo esc_attr($link_color); ?>"><span><?php _e('Link color', 'education'); ?></span></div>
						<div class="iColorPicker" data-options="menu_color" data-value="<?php echo esc_attr($menu_color); ?>"><span><?php _e('Menu color', 'education'); ?></span></div>
						<div class="iColorPicker" data-options="user_color" data-value="<?php echo esc_attr($user_color); ?>"><span><?php _e('User color', 'education'); ?></span></div>
					</div>
				</div>

				<div class="co_section">
					<div class="co_label"><?php _e('Background pattern', 'education'); ?></div>
				...
				<div class="co_section">
					<div class="co_label"><?php _e('Background image', 'education'); ?></div>
